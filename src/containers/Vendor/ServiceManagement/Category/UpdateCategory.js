...
const UpdateCategory = (props) => {
  ...
  const onFinish = (values) => {
    ...
    var langarr = [{
      languageid: 1,
      categoryname: values["1category"],
      categorydesc: values["1categorydesc"]
      },{languageid: 2,
      categoryname: values["2category"] ? values["2category"] : values["1category"],
      categorydesc: values["2categorydesc"] ? values["2categorydesc"] : values["1categorydesc"]
    }]
                            ...
                            <Row>
                              <Col span={24} className="inner-content">
                                <Form.Item
                                  ...
                                  label={getLocaleMessages({
                                    id: "categorydesc.name",
                                  })}
                                  initialValue={
                                    state.categorydesc
                                    // state.language
                                    //   ? filterCatDesc(state.language, lang.id)
                                    //   : ""
                                  }
                                >
                                  <Input />
