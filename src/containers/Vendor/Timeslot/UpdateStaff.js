          ...
          <div>
            ...
            <Form {...formProps}
              ...
              initialValues={{
                  ...
                  status: state.status,
                  joindate: moment(stringToDate(state.employee_startdate,"dd-MM-yyyy","-"))
              ...
              <Col span={24} className="inner-content">
                  ...
                  <Col span={12} className="inner-content">
                    ...
                    >
                      <Select
                        mode="multiple"
                        name = "serviceid"
                        defaultValue = {state.serviceid.length ? getSelectServices() : []}
                ...
                <Row>
                  <Col span={24} className="inner-content">
                    <Form.Item label={getLocaleMessages({id: 'staff.image.label'})}>{localImage}
                      <ImageUploader
                        isSingleImage={true}
